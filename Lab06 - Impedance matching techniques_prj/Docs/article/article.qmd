...
e a rede de adaptação tem o objetivo de obter $Z_i=R_s\parallelsum\left(jX_p\right)$, assim,


$$
  \begin{split}
    Z_i&=\frac{jR_sX_p}{R_s+jX_p}\implies\\
    &=\frac{R_sX_p^2}{R_s^2+X_p^2} + j\frac{R_s^2X_p}{R_s^2+X_p^2}
  \end{split}
$$
...
$$
  R_L=\frac{R_sX_p^2}{R_s^2+X_p^2}
$$

e

$$
  X_s=\frac{R_s^2X_p}{R_s^2+X_p^2}
$$
