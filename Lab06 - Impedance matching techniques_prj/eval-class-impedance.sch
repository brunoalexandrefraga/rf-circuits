...
<Properties>
View=-1,5,1630,1265,1.81426,1364,1176
Grid=10,10,1
DataSet=*.dat
DataDisplay=*.sch
OpenDisplay=1
...
.SW SW1 1 1500 590 0 63 0 0 "AC1" 1 "BL" 1 "lin" 1 "0.001" 1 "0.01" 1 "1000" 1
.AC AC1 1 1420 120 0 38 0 0 "list" 1 "1 GHz" 0 "10 GHz" 0 "fs" 1 "no" 0 "none" 0
.SW SW2 0 1340 590 0 63 0 0 "AC1" 1 "GL" 1 "lin" 1 "Gs" 1 "Gs*6" 1 "1000" 1
Eqn Eqn1 1 30 210 0 8 0 0 "fs=2.4e9=" 1 "ws=2*pi*fs=" 1 "Gs=1/65=" 1 "Ls=10e-9=" 1 "Bs=-1/(ws*Ls)=" 1 "GL=4*Gs=" 1 "is=100 mA=" 1 "BL=0.1=" 1 "yes" 0
</Components>
<Wires>
...
<Rect 890 827 320 208 31 #c0c0c0 1 00 1 0 0.5 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 "" "" "">
	...
	<"PL" "" #0000ff 0 3 0 0 0 0 "">
	  <Mkr 0.00663063 200 -267 3 1 0 0 0 50>
</Rect>
<Rect 890 1187 320 208 31 #c0c0c0 1 00 1 0.0153846 0.02 0.0923077 1 0.464286 0.2 0.892857 1 0 0 0 315 0 225 "" "\eta" "">
	...
	<"n" "" #ff0000 0 3 0 0 0 0 "">
	  <Mkr 0.00155856 20 -187 3 1 0 0 0 50>
	  <Mkr 0.00802703 160 -187 3 1 0 0 0 50>
</Rect>
