...
![Resultados preliminares do amplificador](../images/results-ampl.png){width=300, #fig-results-ampl}
 ...
 Nessa primeira análise, pode-se perceber que a figura de ruído mínima ainda não foi atendida. Para que essa figura de ruído mínima seja obtida, é necessário que a impedância ótima seja utilizada como impedância de fonte.
