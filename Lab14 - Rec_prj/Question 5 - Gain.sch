...
<Properties>
View=-363,-139,1576,1184,0.605826,60,0
Grid=10,10,1
DataSet=*.dat
DataDisplay=*.sch
OpenDisplay=1
...
Text -185 191 16 #000000 0 5. Avalie os  ganhos de tensão, corrente e potência e o  \n ponto de compressão em 1 dB.
Text -255 261 16 #000000 0 Neste arquivo estão apresentados os ganhos de tensão, \n corrente e potência do cirucito projetado. Para essa medição \n foi utilizado o subcircuito do amplificador. Como já era de se \n esperar, o ganho de tensão não é tão grande, mas o ganho \n de corrente é substancial, fornecendo uma alta potência à \n carga.
</Paintings>
