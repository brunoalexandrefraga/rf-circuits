...
Utilizando o circuito apresentado na [Fig. @fig-results], pode-se analisar a estabilidade do circuito por meio do parâmetro $\mu$, conforme é apresentado na [Fig. @fig-results-amplifier-stability].
