...
Semelhantemente ao que foi realizado para o capacitor, inicialmente selecionou-se um indutor com valor próximo ao que foi obtido analiticamente. Sendo assim, o indutor selecionado foi o de *part number* `LQH32MN820J23#`. Esse trata-se de um indutor de 82 $\mu\text{H}$, dimensões de 1210 (*inches*), temperatura de operação de -40°C a 85°C, SRF (*self resonance frequency*) de 8,5 MHz o que é extremamente baixo, ainda mais para o presente circuito (será avaliado poseteriormente) e tolerância de 5%.
