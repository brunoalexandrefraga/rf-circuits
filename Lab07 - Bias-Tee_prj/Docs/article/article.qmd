...
\begin{figure}[h]
  \centering
  \begin{circuitikz}[american]
  	\draw (-2, -2.5) coordinate(point1) to[R, l=$R_s$] ++(0, 2) to[C, l=$C$] ++(3, 0) coordinate(point2) to[L, l=$L$] ++(0, -3.5) coordinate(point3) node[ground]{} ;
  	\draw (point1) to[vsource, l=$V_s$] ++(0, -1.5) to[short] (point3) ;
  	\draw (point2) to[short] ++(2, 0) to[R, l=$R_L$] ++(0, -3.5) to[short] (point3) ;
  \end{circuitikz}
