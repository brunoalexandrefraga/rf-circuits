...
<Properties>
View=-120,-121,1655,1100,0.605826,0,80
Grid=10,10,1
DataSet=*.dat
DataDisplay=*.sch
OpenDisplay=1
...
C C1 1 640 440 -26 17 0 0 "C" 1 "0" 0 "" 0 "neutral" 0 "SMD0603" 0
Eqn Int 1 80 410 0 8 0 0 "f=frequency=" 1 "omega=2*pi*f=" 1 "XC=1/(omega*C)=" 1 "XL=omega*L=" 1 "no" 0
...
670 440 800 440 "" 0 0 0 ""
410 440 410 500 "" 0 0 0 ""
410 440 610 440 "" 0 0 0 ""
