...
<Properties>
View=16,-90,1481,809,0.91187,0,120
Grid=10,10,1
DataSet=*.dat
DataDisplay=*.sch
OpenDisplay=1
...
Sub SUB1 1 880 240 -26 51 0 0 "parallel-atenuator.sch" 0
Sub SUB2 1 510 600 -26 51 0 0 "parallel-atenuator.sch" 0
Eqn Norton 1 950 520 0 8 0 0 "Yn=in.i/vo2.dv=" 1 "So=iN.i^2/(8*real(Yn))=" 1 "No=iN.in*conj(iN.in)/(4*real(Yn))=" 1 "Ga=abs(So/Si)=" 1 "SNRo=So/No=" 1 "F=SNRi/SNRo=" 1 "NF=10*log10(F)=" 1 "yes" 0
</Components>
<Wires>
