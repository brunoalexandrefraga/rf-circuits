...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{asdfsad211.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{ino2-diode-serie-curto.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{model-circuit-diode-parallel.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{original-circuit-parallel-diode-open.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{parallel-results.png}
