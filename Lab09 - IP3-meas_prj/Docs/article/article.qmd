...
Para facilitar a resolução dessa equação, faz-se $x=g_mR_E$, obtendo, assim,

$$
  \frac{\left(1+x\right)^4}{1-2x}=16
$$
...
Dessa forma, é possível calcular o valor de $R_E$ por meio da seguinte equação
